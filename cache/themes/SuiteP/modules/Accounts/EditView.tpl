...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_TEST">

{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_TEST' module='Accounts'}{/capture}
{$label|strip_semicolon}:

{/minify}
</div>

<div class="col-xs-12 col-sm-8 edit-view-field " type="relate" field="test_c"  >
{counter name="panelFieldCount" print=false}

<input type="text" name="{$fields.test_c.name}" class="sqsEnabled" tabindex="0" id="{$fields.test_c.name}" size="" value="{$fields.test_c.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.test_c.id_name}" 
id="{$fields.test_c.id_name}" 
value="{$fields.tut1_tut1_id_c.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.test_c.name}" id="btn_{$fields.test_c.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.test_c.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"tut1_tut1_id_c","name":"test_c"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.test_c.name}" id="btn_clr_{$fields.test_c.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.test_c.name}', '{$fields.test_c.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.test_c.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_TUT1_TUT1_ACCOUNTS_1_FROM_TUT1_TUT1_TITLE">

{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_TUT1_TUT1_ACCOUNTS_1_FROM_TUT1_TUT1_TITLE' module='Accounts'}{/capture}
{$label|strip_semicolon}:

{/minify}
</div>

<div class="col-xs-12 col-sm-8 edit-view-field " type="relate" field="tut1_tut1_accounts_1_name"  >
{counter name="panelFieldCount" print=false}

<input type="text" name="{$fields.tut1_tut1_accounts_1_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.tut1_tut1_accounts_1_name.name}" size="" value="{$fields.tut1_tut1_accounts_1_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.tut1_tut1_accounts_1_name.id_name}" 
id="{$fields.tut1_tut1_accounts_1_name.id_name}" 
value="{$fields.tut1_tut1_accounts_1tut1_tut1_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.tut1_tut1_accounts_1_name.name}" id="btn_{$fields.tut1_tut1_accounts_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.tut1_tut1_accounts_1_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"tut1_tut1_accounts_1tut1_tut1_ida","name":"tut1_tut1_accounts_1_name"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.tut1_tut1_accounts_1_name.name}" id="btn_clr_{$fields.tut1_tut1_accounts_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.tut1_tut1_accounts_1_name.name}', '{$fields.tut1_tut1_accounts_1_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.tut1_tut1_accounts_1_name.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
addToValidate('EditView', 'test_c', 'relate', false,'{/literal}{sugar_translate label='LBL_TEST' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'tut1_tut1_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_TEST_TUT1_TUT1_ID' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'tut1_tut1_accounts_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_TUT1_TUT1_ACCOUNTS_1_FROM_TUT1_TUT1_TITLE' module='Accounts' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'test_c', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Accounts' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_TEST' module='Accounts' for_js=true}{literal}', 'tut1_tut1_id_c' );
addToValidateBinaryDependency('EditView', 'tut1_tut1_accounts_1_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Accounts' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_TUT1_TUT1_ACCOUNTS_1_FROM_TUT1_TUT1_TITLE' module='Accounts' for_js=true}{literal}', 'tut1_tut1_accounts_1tut1_tut1_ida' );
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['EditView_assigned_user_name']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects['EditView_parent_name']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["EditView_parent_name","parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["parent_id"],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects['EditView_campaign_name']={"form":"EditView","method":"query","modules":["Campaigns"],"group":"or","field_list":["name","id"],"populate_list":["campaign_id","campaign_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["campaign_id"],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects['EditView_test_c']={"form":"EditView","method":"query","modules":["tut1_tut1"],"group":"or","field_list":["name","id"],"populate_list":["test_c","tut1_tut1_id_c"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects['EditView_tut1_tut1_accounts_1_name']={"form":"EditView","method":"query","modules":["tut1_tut1"],"group":"or","field_list":["name","id"],"populate_list":["tut1_tut1_accounts_1_name","tut1_tut1_accounts_1tut1_tut1_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>{/literal}
