<?php /* Smarty version 2.6.31, created on 2019-04-12 12:14:19
...
<?php $this->_tag_stack[] = array('minify', array()); $_block_repeat=true;smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TEST','module' => 'Accounts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['test_c']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['test_c']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['test_c']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['test_c']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['test_c']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['tut1_tut1_id_c']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['test_c']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['test_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['test_c']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"tut1_tut1_id_c","name":"test_c"}}'; ?>
, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['test_c']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['test_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['test_c']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['test_c']['id_name']; ?>
...
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['test_c']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
<?php $this->_tag_stack[] = array('minify', array()); $_block_repeat=true;smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TUT1_TUT1_ACCOUNTS_1_FROM_TUT1_TUT1_TITLE','module' => 'Accounts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['tut1_tut1_accounts_1_name']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['tut1_tut1_accounts_1_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['tut1_tut1_accounts_1_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['tut1_tut1_accounts_1_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['tut1_tut1_accounts_1_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['tut1_tut1_accounts_1tut1_tut1_ida']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['tut1_tut1_accounts_1_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['tut1_tut1_accounts_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['tut1_tut1_accounts_1_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"tut1_tut1_accounts_1tut1_tut1_ida","name":"tut1_tut1_accounts_1_name"}}'; ?>
, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['tut1_tut1_accounts_1_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['tut1_tut1_accounts_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['tut1_tut1_accounts_1_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['tut1_tut1_accounts_1_name']['id_name']; ?>
');"  value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_LABEL'), $this);?>
" ><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['tut1_tut1_accounts_1_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
<?php echo '\' );
addToValidate(\'EditView\', \'test_c\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TEST','module' => 'Accounts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'tut1_tut1_id_c\', \'id\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TEST_TUT1_TUT1_ID','module' => 'Accounts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'tut1_tut1_accounts_1_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TUT1_TUT1_ACCOUNTS_1_FROM_TUT1_TUT1_TITLE','module' => 'Accounts','for_js' => true), $this);?>
<?php echo '\' );
